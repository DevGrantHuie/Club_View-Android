...
public class ADMIN_UpcomingEvents extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin__upcoming_events);

        CreateEventButton = findViewById(R.id.CreateEventButton);
        CreateEventButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ADMIN_UpcomingEvents.this, com.tinhat.ClubView.ADMIN_CreateEvent.class);
        ...
        if (!UpcomingEventsString.equals("")) {
            ...
            lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                    ...
                    Intent intent = new Intent(ADMIN_UpcomingEvents.this, UpcomingEventsDetail.class);
